...
const checks = [
  ...
  { file: 'src/screens/OutgoingCallScreen.js', must: ['NativeCallRoom', 'livekit-invite', 'startVideoCallRequest'] },
  { file: 'src/screens/IncomingCallScreen.js', must: ['NativeCallRoom', 'livekit-accepted', 'fp_embed_incoming_call'] },
  { file: 'src/livekit/NativeCallRoom.js', must: ['call-', 'canPublish: true', 'LiveKitRoom'] },
  ...
  { file: 'src/screens/GoLiveBroadcastScreen.js', must: ['NativeGoLiveBroadcaster', 'embed-go-live'] },
  { file: 'src/livekit/NativeGoLiveBroadcaster.js', must: ['createLiveKitTokenRequest', 'stream-', 'setCameraEnabled'] },
