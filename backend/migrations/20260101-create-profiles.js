  ...
  up: async (queryInterface, Sequelize) => {
    ...
    if (!tables.includes('Profiles')) {
      await queryInterface.createTable('Profiles', {
        ...
        achievements: { type: Sequelize.JSON, allowNull: true, defaultValue: [] },
        matches: { type: Sequelize.JSON, allowNull: true, defaultValue: [] },
        media: { type: Sequelize.JSON, allowNull: true, defaultValue: [] },
