module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('ClubStaff', {
      ...
      staffRole: { type: Sequelize.ENUM('head_coach','assistant_coach','fitness_coach','goalkeeper_coach','technical_coach','tactical_coach','medical_staff','physiotherapist','sports_psychologist','scout','analyst','kit_manager','other'), allowNull: false },
